...
//////////////////////////////italy//////////////////////////////////////////
  ...
  ///////////////////////////////// china ////////////////////////////////
    ...
    ////////////////////////////////////////// india /////////////////////////////////////////////////
        // Load in geojson data
        var confirmedUrl= "https://api.covid19api.com/live/country/india/status/confirmed";
        var geojson;
        // Grab data with d3 !!!!
        d3.json(confirmedUrl , function(data) {
          console.log(data);
        ...
        // Load in geojson data
        var deathsUrl= "https://api.covid19api.com/live/country/india/status/deaths";
        var geojson;
        // Grab data with d3 !!!!
        d3.json(deathsUrl , function(data) {
          console.log(data);
        ...
        // Load in geojson data
        var recoveredUrl= "https://api.covid19api.com/live/country/india/status/recovered";
        var geojson;
        // Grab data with d3 !!!!
        d3.json(recoveredUrl , function(data) {
          console.log(data);
...
///////////////////////////////////////////japan///////////////////////////////////////////////////////
    ...
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/japan/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/japan/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/japan/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
/////////////////////////////////brazil////////////////////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/brazil/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/brazil/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/brazil/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
/////////////////////////////////////////mexico/////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/mexico/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/mexico/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/mexico/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
////////////////////////////////////////////Australia///////////////////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/australia/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/australia/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/australia/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
//////////////////////////////////////////canada//////////////////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/canada/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/canada/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/canada/japan/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
/////////////////////////////////////south korea//////////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/south-korea/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/south-korea/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/south-korea/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
...
/////////////////////////////////south-africa////////////////////////////////////////////////
    // Load in geojson data
    var confirmedUrl= "https://api.covid19api.com/live/country/south-africa/status/confirmed";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(confirmedUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var deathsUrl= "https://api.covid19api.com/live/country/south-africa/status/deaths";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(deathsUrl , function(data) {
      console.log(data);
    ...
    // Load in geojson data
    var recoveredUrl= "https://api.covid19api.com/live/country/south-africa/status/recovered";
    var geojson;
    // Grab data with d3 !!!!
    d3.json(recoveredUrl , function(data) {
      console.log(data);
